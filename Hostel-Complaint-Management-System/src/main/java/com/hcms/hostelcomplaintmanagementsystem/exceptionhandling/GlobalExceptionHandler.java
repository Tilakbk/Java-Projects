...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDto> handleUsernameNotFoundException(UsernameNotFoundException e, HttpServletRequest request)
    {
        log.warn("Not found:{}", e.getMessage());

        ApiErrorDto apiErrorDto= new ApiErrorDto(HttpStatus.NOT_FOUND.value(),"Username invalid",e.getMessage(),request.getRequestURI());
